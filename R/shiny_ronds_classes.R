    ...
    server <- function(input, output, session) {
      ...
      EXPORT_PROJET_QGIS_RP_AC <- function(file)
      {
        ...
        if(elargi_rp_ac())
        {
          ...
          suppressWarnings(st_write(fond_ronds_classes_elargi, paste0(rep_sortie,"/fond_maille_elargi_carte.shp"), delete_dsn = TRUE, quiet = TRUE))
        ...
        suppressWarnings(st_write(fond_ronds_classes, paste0(rep_sortie,"/fond_maille_carte.shp"), delete_dsn = TRUE, quiet = TRUE))
